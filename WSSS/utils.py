...
import cmapy
def visualize_heatmap(experiments, images, attmaps, epoch, cnt, phase='train', seg=True):
    ...
    for i in range(images.shape[0]):
        ...
        if seg:
            ...
            cv2.imwrite('images/{}/{}/colormaps/epoch-{}-{}-seg.jpg'.format(experiments, phase, cnt, i), temp)
